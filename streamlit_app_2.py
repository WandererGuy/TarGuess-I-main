...
st.title("Generating Masklist for Target API !!!")
...
TARGUESS_URL_WORDLIST = f"http://{host_ip}:{TARGUESS_PORT_NUM}/generate-target-mask-list/"

def targuess_generate_masklist_for_app(targuess_train_result_refined_path, 
                      targuess_url, 
                      target_info: dict, 
...
def send_to_api(data):
        ...
        final_res = targuess_generate_masklist_for_app(
